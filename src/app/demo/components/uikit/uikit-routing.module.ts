...
@NgModule({
    imports: [RouterModule.forChild([
        ...
        { path: 'pdf-viewer', data: { breadcrumb: 'Pdf Viewer' }, loadChildren: () => import('./pdf-viewer/pdf-viewer.module').then(m => m.DemoPdfViewerModule) },
        { path: 'pdf', data: { breadcrumb: 'Pdf' }, loadChildren: () => import('./pdf/pdf.module').then(m => m.PdfModule) },
